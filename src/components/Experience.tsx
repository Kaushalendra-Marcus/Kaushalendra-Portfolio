    ...
    <div style={{ animation: `fadeInUp 0.5s ease-out ${index * 0.1}s both` }}>
      ...
      <div className="flex flex-col sm:flex-row sm:gap-8">
        ...
        <div className="flex-shrink-0 sm:w-44 mb-3 sm:mb-0 sm:pt-0.5">
          <p className="text-[11px] text-white/40 font-mono mb-1.5">{exp.period}</p>
          ...
          {exp.note && (
            <p className="text-[10px] text-white/35 font-mono mt-1.5 pl-8">
              {exp.note}
            </p>
          )}
        </div>
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-medium text-white/75 mb-2.5">{exp.role}</p>
          ...
          >
            ...
            {open ? "Hide details" : `${exp.achievements.length} highlights`}
          </button>
